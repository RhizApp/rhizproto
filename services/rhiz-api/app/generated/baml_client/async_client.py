...
class BamlAsyncClient:
    ...
    async def AssessIntroductionFeasibility(self, requester_did: str,target_did: str,proposed_path: str,relationship_data: str,introduction_purpose: str,timing_context: typing.Optional[str] = None,
        ...
        if 'on_tick' in baml_options:
            ...
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="AssessIntroductionFeasibility", args={
    ...
    async def AssessRelationshipQuality(self, relationship_context: str,claimed_strength: int,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="AssessRelationshipQuality", args={
    ...
    async def ExplainConvictionScore(self, relationship_uri: str,conviction_data: str,attestations: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ExplainConvictionScore", args={
    ...
    async def ExplainPathChoice(self, from_did: str,to_did: str,chosen_path: str,alternative_paths: str,selection_criteria: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ExplainPathChoice", args={
    ...
    async def ExplainTrustScore(self, entity_did: str,trust_metrics: str,network_context: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ExplainTrustScore", args={
    ...
    async def ExtractRelationshipsFromText(self, text: str,context_hint: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractRelationshipsFromText", args={
    ...
    async def GenerateFollowup(self, original_message: str,days_since_sent: int,any_responses: bool,new_context: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="GenerateFollowup", args={
    ...
    async def GenerateForwardingIntro(self, requester_context: str,target_context: str,intermediary_relationships: str,introduction_purpose: str,requested_outcome: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="GenerateForwardingIntro", args={
    ...
    async def GenerateIntroRequest(self, requester_did: str,requester_context: str,intermediary_did: str,intermediary_context: str,target_did: str,target_context: str,introduction_purpose: str,relationship_data: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="GenerateIntroRequest", args={
    ...
    async def PlanIntroductionOrchestration(self, requester_did: str,target_did: str,intro_path: str,relationship_data: str,introduction_purpose: str,
        baml_options: BamlCallOptions = {},
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="PlanIntroductionOrchestration", args={
...
class BamlStreamClient:
    ...
    def AssessIntroductionFeasibility(self, requester_did: str,target_did: str,proposed_path: str,relationship_data: str,introduction_purpose: str,timing_context: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.IntroFeasibility, types.IntroFeasibility]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="AssessIntroductionFeasibility", args={
            "requester_did": requester_did,"target_did": target_did,"proposed_path": proposed_path,"relationship_data": relationship_data,"introduction_purpose": introduction_purpose,"timing_context": timing_context,
        })
        return baml_py.BamlStream[stream_types.IntroFeasibility, types.IntroFeasibility](
          result,
    ...
    def AssessRelationshipQuality(self, relationship_context: str,claimed_strength: int,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.RelationshipQualityAssessment, types.RelationshipQualityAssessment]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="AssessRelationshipQuality", args={
            "relationship_context": relationship_context,"claimed_strength": claimed_strength,
        })
        return baml_py.BamlStream[stream_types.RelationshipQualityAssessment, types.RelationshipQualityAssessment](
          result,
    ...
    def ExplainConvictionScore(self, relationship_uri: str,conviction_data: str,attestations: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ConvictionExplanation, types.ConvictionExplanation]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExplainConvictionScore", args={
            "relationship_uri": relationship_uri,"conviction_data": conviction_data,"attestations": attestations,
        })
        return baml_py.BamlStream[stream_types.ConvictionExplanation, types.ConvictionExplanation](
          result,
    ...
    def ExplainPathChoice(self, from_did: str,to_did: str,chosen_path: str,alternative_paths: str,selection_criteria: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.PathExplanation, types.PathExplanation]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExplainPathChoice", args={
            "from_did": from_did,"to_did": to_did,"chosen_path": chosen_path,"alternative_paths": alternative_paths,"selection_criteria": selection_criteria,
        })
        return baml_py.BamlStream[stream_types.PathExplanation, types.PathExplanation](
          result,
    ...
    def ExplainTrustScore(self, entity_did: str,trust_metrics: str,network_context: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.TrustExplanation, types.TrustExplanation]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExplainTrustScore", args={
            "entity_did": entity_did,"trust_metrics": trust_metrics,"network_context": network_context,
        })
        return baml_py.BamlStream[stream_types.TrustExplanation, types.TrustExplanation](
          result,
    ...
    def ExtractRelationshipsFromText(self, text: str,context_hint: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.RelationshipExtractionResult, types.RelationshipExtractionResult]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractRelationshipsFromText", args={
            "text": text,"context_hint": context_hint,
        })
        return baml_py.BamlStream[stream_types.RelationshipExtractionResult, types.RelationshipExtractionResult](
          result,
    ...
    def GenerateFollowup(self, original_message: str,days_since_sent: int,any_responses: bool,new_context: typing.Optional[str] = None,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.FollowupMessage, types.FollowupMessage]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="GenerateFollowup", args={
            "original_message": original_message,"days_since_sent": days_since_sent,"any_responses": any_responses,"new_context": new_context,
        })
        return baml_py.BamlStream[stream_types.FollowupMessage, types.FollowupMessage](
          result,
    ...
    def GenerateForwardingIntro(self, requester_context: str,target_context: str,intermediary_relationships: str,introduction_purpose: str,requested_outcome: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.ForwardingIntro, types.ForwardingIntro]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="GenerateForwardingIntro", args={
            "requester_context": requester_context,"target_context": target_context,"intermediary_relationships": intermediary_relationships,"introduction_purpose": introduction_purpose,"requested_outcome": requested_outcome,
        })
        return baml_py.BamlStream[stream_types.ForwardingIntro, types.ForwardingIntro](
          result,
    ...
    def GenerateIntroRequest(self, requester_did: str,requester_context: str,intermediary_did: str,intermediary_context: str,target_did: str,target_context: str,introduction_purpose: str,relationship_data: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.IntroductionMessage, types.IntroductionMessage]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="GenerateIntroRequest", args={
            "requester_did": requester_did,"requester_context": requester_context,"intermediary_did": intermediary_did,"intermediary_context": intermediary_context,"target_did": target_did,"target_context": target_context,"introduction_purpose": introduction_purpose,"relationship_data": relationship_data,
        })
        return baml_py.BamlStream[stream_types.IntroductionMessage, types.IntroductionMessage](
          result,
    ...
    def PlanIntroductionOrchestration(self, requester_did: str,target_did: str,intro_path: str,relationship_data: str,introduction_purpose: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[stream_types.IntroOrchestrationPlan, types.IntroOrchestrationPlan]:
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="PlanIntroductionOrchestration", args={
            "requester_did": requester_did,"target_did": target_did,"intro_path": intro_path,"relationship_data": relationship_data,"introduction_purpose": introduction_purpose,
        })
        return baml_py.BamlStream[stream_types.IntroOrchestrationPlan, types.IntroOrchestrationPlan](
          result,
...
class BamlHttpRequestClient:
    ...
    async def AssessIntroductionFeasibility(self, requester_did: str,target_did: str,proposed_path: str,relationship_data: str,introduction_purpose: str,timing_context: typing.Optional[str] = None,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="AssessIntroductionFeasibility", args={
            "requester_did": requester_did,"target_did": target_did,"proposed_path": proposed_path,"relationship_data": relationship_data,"introduction_purpose": introduction_purpose,"timing_context": timing_context,
        }, mode="request")
        return result
    async def AssessRelationshipQuality(self, relationship_context: str,claimed_strength: int,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="AssessRelationshipQuality", args={
            "relationship_context": relationship_context,"claimed_strength": claimed_strength,
        }, mode="request")
        return result
    async def ExplainConvictionScore(self, relationship_uri: str,conviction_data: str,attestations: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExplainConvictionScore", args={
            "relationship_uri": relationship_uri,"conviction_data": conviction_data,"attestations": attestations,
        }, mode="request")
        return result
    async def ExplainPathChoice(self, from_did: str,to_did: str,chosen_path: str,alternative_paths: str,selection_criteria: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExplainPathChoice", args={
            "from_did": from_did,"to_did": to_did,"chosen_path": chosen_path,"alternative_paths": alternative_paths,"selection_criteria": selection_criteria,
        }, mode="request")
        return result
    async def ExplainTrustScore(self, entity_did: str,trust_metrics: str,network_context: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExplainTrustScore", args={
            "entity_did": entity_did,"trust_metrics": trust_metrics,"network_context": network_context,
        }, mode="request")
        return result
    async def ExtractRelationshipsFromText(self, text: str,context_hint: typing.Optional[str] = None,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractRelationshipsFromText", args={
            "text": text,"context_hint": context_hint,
        }, mode="request")
        return result
    async def GenerateFollowup(self, original_message: str,days_since_sent: int,any_responses: bool,new_context: typing.Optional[str] = None,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="GenerateFollowup", args={
            "original_message": original_message,"days_since_sent": days_since_sent,"any_responses": any_responses,"new_context": new_context,
        }, mode="request")
        return result
    async def GenerateForwardingIntro(self, requester_context: str,target_context: str,intermediary_relationships: str,introduction_purpose: str,requested_outcome: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="GenerateForwardingIntro", args={
            "requester_context": requester_context,"target_context": target_context,"intermediary_relationships": intermediary_relationships,"introduction_purpose": introduction_purpose,"requested_outcome": requested_outcome,
        }, mode="request")
        return result
    async def GenerateIntroRequest(self, requester_did: str,requester_context: str,intermediary_did: str,intermediary_context: str,target_did: str,target_context: str,introduction_purpose: str,relationship_data: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="GenerateIntroRequest", args={
            "requester_did": requester_did,"requester_context": requester_context,"intermediary_did": intermediary_did,"intermediary_context": intermediary_context,"target_did": target_did,"target_context": target_context,"introduction_purpose": introduction_purpose,"relationship_data": relationship_data,
        }, mode="request")
        return result
    async def PlanIntroductionOrchestration(self, requester_did: str,target_did: str,intro_path: str,relationship_data: str,introduction_purpose: str,
        ...
        result = await self.__options.merge_options(baml_options).create_http_request_async(function_name="PlanIntroductionOrchestration", args={
            "requester_did": requester_did,"target_did": target_did,"intro_path": intro_path,"relationship_data": relationship_data,"introduction_purpose": introduction_purpose,
        }, mode="request")
        return result
